...
class PhotoStore {
    ...
    func fetchPhotoOfTheDay(completion: @escaping (Result<[Photo], Error>) -> Void) {
        // Use the public photoOfTheDay URL property
        guard let requestURL = NASAAPI.photoOfTheDay else {
            print("Invalid URL for fetching photo of the day.")
            return
        }
